...
char *ClientConnect(int clientNum, qboolean firstTime, qboolean isBot)
{
	...
	// Send HTTP log for player connection
	value = Info_ValueForKey(userinfo, "ip");
	G_HTTPLog_PlayerConnect(clientNum, client->pers.netname, value);
...
void ClientDisconnect(int clientNum)
{
	...
	// Send HTTP log for player disconnection
	G_HTTPLog_PlayerDisconnect(clientNum, ent->client->pers.netname);
